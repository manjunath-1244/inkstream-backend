...
import { ApiTags, ApiOperation, ApiOkResponse, ApiBearerAuth, ApiProperty } from '@nestjs/swagger';
...
export class SubscriptionsController {
  ...
  @ApiOkResponse({ type: Subscription, description: 'Returns active subscription or null' })
