...
export class NotificationsController {
  ...
  @ApiOkResponse({ type: [Notification], description: 'Returns paginated list of notifications' })
  ...
  @ApiOkResponse({ type: Number, description: 'Returns the number of unread notifications' })
